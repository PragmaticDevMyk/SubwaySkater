...
public class LevelManager : MonoBehaviour
{
    ...
    public Segment GetSegment(int id, bool transition)
    {
        Segment s = null;
        s = segments.Find(
            x => x.SegId == id && x.transition == transition && !x.gameObject.activeSelf
        );
            ...
            GameObject go =
                Instantiate(
                    (transition)
                        ...
                        : availableSegments[id].gameObject
                ) as GameObject;
    ...
    {
        Piece p = pieces.Find(
            x => x.type == pt && x.visualIndex == visualIndex && !x.gameObject.activeSelf
        );
